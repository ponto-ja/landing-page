...
export const CTAToWebsite: FC<CTAToWebsiteProps> = ({ title, className = '' }) => {
  return (
    <Link
      ...
      className={twMerge(
        'bg-violet-900 text-white font-inter font-medium text-base rounded-md py-2 px-3 hover:opacity-80 transition-opacity duration-300 mx-auto block w-fit mt-12',
        className,
      )}
      target="_blank"
      rel="no-referrer">
